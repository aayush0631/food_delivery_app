...
class Validator {
  ...
  static String? password(String? value) {
    final requiredValidation = required(value, 'password');
    if (requiredValidation != null) {
      return requiredValidation;
    }
    return null;
  ...
  /// Usage:
  /// ```dart
  /// validator: Validator.noOfDishes
  /// ```
  static String? noOfDishes(String? value) {
    final requiredValidation = required(value, 'No of dishes');
    if (requiredValidation != null) {
      return requiredValidation;
    }
